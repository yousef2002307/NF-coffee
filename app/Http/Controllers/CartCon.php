...
class CartCon extends Controller
{
    ...
    public function store(Request $request)
    {
       ...
       $product->save();
        ...
        // Activity::create([
        //     'user_id' => $user_id,
        //     "log" => Auth::user()->name ." added ". $product->name ." product to cart",
        // ]);
    ...
    public function show(string $id)
    {
        ...
        $cartItem = Cart::with('product')->where('user_id', $user_id)->where('id', $id)->first();
    ...
    public function destroy(string $id)
    {
        ...
        if ($cartItem) {
            ...
            // Activity::create([
            //     'user_id' => $user_id,
            //     "log" => Auth::user()->name ." removed "." product from his cart",
            // ]);
